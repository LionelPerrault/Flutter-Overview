<!-- when editing this file also update https://github.com/LionelPerrault/.github/blob/main/CONTRIBUTING.md -->

Contributing to Flutter
=======================

_tl;dr: join [Discord](https://github.com/LionelPerrault/flutter/wiki/Chat), be [courteous](CODE_OF_CONDUCT.md), follow the steps below to set up a development environment; if you stick around and contribute, you can [join the team](https://github.com/LionelPerrault/flutter/wiki/Contributor-access) and get commit access._
...
see the [Contributor access](https://github.com/LionelPerrault/flutter/wiki/Contributor-access)
page on our wiki.

We communicate primarily over GitHub and [Discord](https://github.com/LionelPerrault/flutter/wiki/Chat).
...
2. [Values](https://github.com/LionelPerrault/flutter/wiki/Values),
...
1. Join the #hackers-triage [Discord channel](https://github.com/LionelPerrault/flutter/wiki/Chat).
...
3. Help out as described in our wiki: https://github.com/LionelPerrault/flutter/wiki/Triage
...
4. Familiarize yourself with our
   [issue hygiene](https://github.com/LionelPerrault/flutter/wiki/Issue-hygiene) wiki page,
...
5. Once you've been doing this for a while, someone will invite you to the flutter-hackers
   ...
   [contributor access](https://github.com/LionelPerrault/flutter/wiki/Contributor-access) wiki
   page for details.
...
The #quality-assurance channel on our [Discord server](https://github.com/LionelPerrault/flutter/wiki/Chat)
is a good place to talk about what you're doing. We're especially eager for QA testing when
we announce a beta release. See https://github.com/LionelPerrault/flutter/wiki/Quality-Assurance for
more details.
...
If you would prefer to write code, you may wish to start with our list of [good first issues](https://github.com/LionelPerrault/flutter/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
1. [Setting up your engine development environment](https://github.com/LionelPerrault/flutter/wiki/Setting-up-the-Engine-development-environment),
...
2. [Setting up your framework development environment](https://github.com/LionelPerrault/flutter/wiki/Setting-up-the-Framework-development-environment),
   which describes the steps you need to configure your computer to
   work on Flutter's framework. Flutter's framework mainly uses Dart.

3. [Tree hygiene](https://github.com/LionelPerrault/flutter/wiki/Tree-hygiene),
   which covers how to land a PR, how to do code review, how to
   handle breaking changes, how to handle regressions, and how to
   handle post-commit test failures.

4. [Our style guide](https://github.com/LionelPerrault/flutter/wiki/Style-guide-for-Flutter-repo),
...
5. [Flutter design doc template](https://flutter.dev/go/template),
   ...
   See also our [guidance for writing design docs](https://github.com/LionelPerrault/flutter/wiki/Design-Documents).
...
there are many pages on [our Wiki](https://github.com/LionelPerrault/flutter/wiki/),
...
the best starting point is to join the #hackers-devrel [Discord channel](https://github.com/LionelPerrault/flutter/wiki/Chat).
...
[Discord](https://github.com/LionelPerrault/flutter/wiki/Chat) server and introduce yourself on the #hackers-deverl, #hackers-framework,
...
We have a [whole section in our style guide](https://github.com/LionelPerrault/flutter/wiki/Style-guide-for-Flutter-repo#documentation-dartdocs-javadocs-etc)
...
We also keep [a list of areas that need better API documentation](https://github.com/LionelPerrault/flutter/issues?q=is%3Aopen+is%3Aissue+label%3A%22d%3A+api+docs%22+sort%3Areactions-%2B1-desc).
...
draws to a canvas, and stored in a [special repository](https://github.com/LionelPerrault/assets-for-api-docs/#readme). It can be a lot of fun
...
channel of our [Discord](https://github.com/LionelPerrault/flutter/wiki/Chat) server.
...
If this is an area that is of interest to you, please join our [Discord](https://github.com/LionelPerrault/flutter/wiki/Chat) and ping Hixie on the #hackers
channel!
