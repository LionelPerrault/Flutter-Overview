...
https://github.com/LionelPerrault/flutter/wiki/Data-driven-Fixes
...
See [dev/bots/test.dart](https://github.com/LionelPerrault/flutter/blob/master/dev/bots/test.dart)
