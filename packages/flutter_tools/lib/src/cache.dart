  ...
  Future<void> _download(Uri url, File file, Status status) async {
    ...
    if (!isAllowedUrl) {
      ...
      _logger.printWarning(
        ...
        'This should not have happened. This is likely a Flutter SDK bug. Please file an issue at https://github.com/LionelPerrault/flutter/issues/new?template=1_activation.yml'
      );
      status.resume();
    }
